...
import { failureLoadCategories, startLoadingCategories, successLoadCategories } from '../reducers/setCategoriesSlice';
...
function *handleGetCategories() {
    ...
    try {
        ...
        const data: TCategoriesItem[] = yield retry(Infinity, retryDelay, fetchCategories);
