...
import { startSendingOrder, successSendingOrder, failureSendingOrder } from '../reducers/sendOrderSlice';
...
function *handleSendOrderSaga(action: PayloadAction<TOrderSendObject>) {
    ...
    try {
        ...
        const response: boolean = yield retry(1, retryDelay, fetchSendOrder, action.payload);
